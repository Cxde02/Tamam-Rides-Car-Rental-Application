...
class DetailFavSc extends StatefulWidget {
  final List<Car> cars;
  //final Book book;
  ...
  @override
  _DetailFavScState createState() => _DetailFavScState();
}

class _DetailFavScState extends State<DetailFavSc> {
            ...
            return StreamBuilder<DocumentSnapshot>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.hasData && snapshot.data!.exists) {
                    ...
                    dismissDialog(); // Start the timer to dismiss the dialog
                    final userData =
                        ...
                        children: [
                          Container(
                            ...
                            child: Lottie.Lottie.asset(
                              'assets/images/jMWnmy9RN7.json', // Replace with your Lottie animation path
                            ),
                          ),
                          SizedBox(height: 14),
                          Text(
                          ...
                          Text(
                            userData['username'],
                            style:
                                TextStyle(fontFamily: 'Barlow', fontSize: 18),
                          ),
                          SizedBox(height: 14),
