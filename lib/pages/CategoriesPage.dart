...
import 'package:homescreen/data/Cat3.dart';
...
import '../data/Cat1.dart';
import '../data/Cat2.dart';
import '../data/Cat4.dart';
import '../data/Cat5.dart';
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: <Widget>[
            SizedBox(height: 5.0),
            Container(
              height: 40.0, // Fixed height for the category section
              child: Stack(
                children: [
                  Text(
                    'Categories',
